<template>
    <Navbar class="bg-purple" solid>

        <template #logo>
            <div class="flex">
                <a href="#" class="flex items-center">
                    <img src="@/assets/penabur-icon.svg" class="h-8 pr-3 mr-3 border-r-2  border-white"
                        alt="Flowbite Logo">
        ...
        <template #default="{ isShowMenu }">
            <NavbarCollapse :isShowMenu="isShowMenu">
                ...
                <NavbarLink linkAttr="to" link="/#faq-scroll" component="RouterLink">
                    <p class="p-0 m-0 uppercase text-white text-2xl  hover:text-amber-300 font-black text-base">Our Caster</p>
                </NavbarLink>
            </NavbarCollapse>
        </template>
        <template #right-side>
